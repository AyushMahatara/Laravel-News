<form class="mb-6" wire:submit="{{$method}}">
    ...
    <div class="py-2 px-4 mb-4 bg-white rounded-lg rounded-t-lg border border-gray-200  dark:border-gray-700
        ...
        <textarea id="{{$inputId}}" rows="6" class="px-0 w-full text-sm text-gray-900 border-0 focus:ring-0 focus:outline-none
                              dark:text-white dark:placeholder-gray-400  @error($state.'.body')
                              border-red-500 @enderror" placeholder="Write a comment..."
