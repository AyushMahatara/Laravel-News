<div>
    ...
    @else
    <article class="p-6 mb-1 text-base bg-white rounded-lg dark:bg-gray-500">
        <footer class="flex justify-between items-center mb-1">
            ...
            <div class="relative">
                <button wire:click="$toggle('showOptions')"
                    class="inline-flex items-center p-2 text-sm font-medium text-center text-gray-400 bg-white rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-50 dark:bg-gray-500 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                    type="button">
    ...
    <article class="p-1 mb-1 ml-1 lg:ml-12 border-t border-gray-200 dark:border-gray-700 dark:bg-gray-500">
