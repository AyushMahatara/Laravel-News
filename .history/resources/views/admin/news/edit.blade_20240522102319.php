                    ...
                    <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                        <form method="POST" action="{{ route('admin.news.update', $news->id) }}">
                            ...
                            <div class="col-span-full">
                                ...
                                @if ($news->image)
                                <div class="mt-4">
                                    <img src="{{ $news->image }}" alt="Current Image" class="w-32 h-32 rounded-md">
                                </div>
                                @endif
                            </div>
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-1">
                                    <input type="date" id="title" name="date" value="{{ old('date', $news->date) }}"
                                        class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                            ...
                            <div class="sm:col-span-6">
                                ...
                                <div class="mt-1">
                                    <textarea name="description" id="" cols="30"
                                        rows="10">{{ old('date', $news->description) }}</textarea>
