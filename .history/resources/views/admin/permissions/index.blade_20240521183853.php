                    ...
                    <li class="flex justify-between gap-x-6 py-5">
                        ...
                        <div class="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                            <div class="text-sm leading-6 text-gray-900">
                                <a href="{{ route('admin.permissions.edit') }}" class=" bg-blue-400 rounded-lg px-2 py-2">Edit</a>
                            </div>
                            <div class="text-sm leading-6 text-gray-900">
                                <a href="{{ route('admin.permissions.destroy') }}" class=" bg-red-400 rounded-lg px-2 py-2">Delete</a>
                            </div>
